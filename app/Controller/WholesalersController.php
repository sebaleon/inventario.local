...
//        $this->layout = 'admin';
    ...
    public function admin_add() {
        ...
        if ($this->request->is('post')
            ...
            $this->request->data['Product']['modified'] = $now;
            ...
            if ($this->Product->save($this->request->data)) {
                ...
                $this->request->data['Price']['cost_price'] = $this->request->data['Product']['list_price'];
                $this->request->data['Price']['cost_price'] = $this->request->data['Product']['sale_price'];
                ...
                if ($this->request->data['price_per_grams']) {
                    $this->request->data['Price']['price_per_grams'] = $this->request->data['price_per_grams'];
                }
