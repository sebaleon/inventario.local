...
//                                   'home'));
	Router::connect('/', array('controller' => 'pages',
        ...
        //Atajo para el login de usuarios => /login
        Router::connect('/login',    array('controller' => 'users', 'action' => 'login', 'admin' => false));
        
        //Router::connect('/logout',    array('controller' => 'users', 'action' => 'login'));
...
//        Router::connect(
//            '/:id/:slug', // E.g. /blog/3-CakePHP_Rocks
//            array('controller' => 'specs', 'action' => 'view', 'admin' => true),
//            array(
